<html>
  ...
  <body style="max-width:600px">
	...
	<header class="w3-bar w3-card w3-theme">
	  ...
	  <h1 class="w3-bar-item float-right"><img class="w3-square" src="profile.png" style="width: 45px;height: 25px;"></h1>
	</header>
	...
	<div class="w3-container" id="cart">
		...
		<h3 id="total">Cart subtotal (0 items): $0.00</h3>
		
		<button id="pay">Continue to checkout</button>
		<p></p>
		<button id="loyalty-signup">Easy Loyalty Signup</button>
		<hr>
	</div>
	<div class="w3-container" id ="suggestions">
		<h2 id="first-item">Recommendations for items across our store.</h2>
		<hr>
